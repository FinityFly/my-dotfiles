...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting you-should-use virtualenv)
...
alias ls='lsd -a --group-dirs=first -1'
alias tt='tt -t 15 -showwpm -notheme -highlight1 -blockcursor -bold'
